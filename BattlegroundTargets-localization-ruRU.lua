...
["Show Range"] = "Отображать расстояние",
 ["This option uses CombatLog scanning."] = "Эта опция использует просмотр CombatLog.",
 ["This option uses a pre-defined spell to check range:"] = "Эта опция использует выбранное заклинание для проверки расстояния",
 ["Disable this option if you have CPU/FPS problems in combat."] = "Выключить эту опцию, если у вас есть проблемы с производительностью.",
