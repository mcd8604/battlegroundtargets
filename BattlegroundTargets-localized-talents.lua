...
if locale == "esES" then
	...
	TLT.PRIEST.spec[2]      = {role = HEALER,  specID = 257, specName = "Sagrado", icon = [[Interface\Icons\Spell_Holy_GuardianSpirit]]} --\ double
	TLT.PRIEST.spec[3]      = {role = HEALER,  specID = 257, specName = "Sagrada", icon = [[Interface\Icons\Spell_Holy_GuardianSpirit]]} --/ double
	TLT.PRIEST.spec[4]      = {role = DAMAGER, specID = 258, specName = "Sombra", icon = [[Interface\Icons\Spell_Shadow_ShadowWordPain]]}
	TLT.WARLOCK = {spec={}}
	...
	TLT.DRUID.spec[3]       = {role = TANK,    specID = 104, specName = "Guardián", icon = [[Interface\Icons\Ability_Racial_BearForm]]}  --\ double
	TLT.DRUID.spec[4]       = {role = TANK,    specID = 104, specName = "Guardiana", icon = [[Interface\Icons\Ability_Racial_BearForm]]} --/ double
	TLT.DRUID.spec[5]       = {role = HEALER,  specID = 105, specName = "Restauración", icon = [[Interface\Icons\Spell_Nature_HealingTouch]]}
	TLT.SHAMAN = {spec={}}
	...
	TLT.PALADIN = {spec={}}
	TLT.PALADIN.spec[1]     = {role = HEALER,  specID =  65, specName = "Sagrado", icon = [[Interface\Icons\Spell_Holy_HolyBolt]]} --\ double
	TLT.PALADIN.spec[2]     = {role = HEALER,  specID =  65, specName = "Sagrada", icon = [[Interface\Icons\Spell_Holy_HolyBolt]]} --/ double
	TLT.PALADIN.spec[3]     = {role = TANK,    specID =  66, specName = "Protección", icon = [[Interface\Icons\Ability_Paladin_ShieldoftheTemplar]]}
	TLT.PALADIN.spec[4]     = {role = DAMAGER, specID =  70, specName = "Reprensión", icon = [[Interface\Icons\Spell_Holy_AuraOfLight]]}
	TLT.MONK = {spec={}}
	TLT.MONK.spec[1]        = {role = TANK,    specID = 268, specName = "Maestro cervecero", icon = [[Interface\Icons\spell_monk_brewmaster_spec]]}
	TLT.MONK.spec[2]        = {role = DAMAGER, specID = 269, specName = "Viajero del viento", icon = [[Interface\Icons\spell_monk_windwalker_spec]]} --\ double
	TLT.MONK.spec[3]        = {role = DAMAGER, specID = 269, specName = "Viajera del viento", icon = [[Interface\Icons\spell_monk_windwalker_spec]]} --/ double
	TLT.MONK.spec[4]        = {role = HEALER,  specID = 270, specName = "Tejedor de niebla", icon = [[Interface\Icons\spell_monk_mistweaver_spec]]}  --\ double
	TLT.MONK.spec[5]        = {role = HEALER,  specID = 270, specName = "Tejedora de niebla", icon = [[Interface\Icons\spell_monk_mistweaver_spec]]} --/ double
