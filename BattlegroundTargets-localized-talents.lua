...
if locale == "esES" then
	...
	TLT.PRIEST.spec[2]      = {role = HEALER,  specID = 257, specName = "Sagrada", icon = [[Interface\Icons\Spell_Holy_GuardianSpirit]]}
	...
	TLT.PALADIN = {spec={}}
	TLT.PALADIN.spec[1]     = {role = HEALER,  specID =  65, specName = "Sagrada", icon = [[Interface\Icons\Spell_Holy_HolyBolt]]}		
